...
export const BentoGridItem = ({
  ...
  const leftLists = ["Student Visa", "Tourist Visa"];
  const rightLists = ["Immigration", "Investor" ,"Job Seeker"];
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#090909] italic"
                  >
                    {item}
                  </span>
                ))}
                {/* <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#070707]"></span> */}
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                ...
                {rightLists.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 
                    lg:opacity-100 rounded-lg text-center bg-[#0a0a0a] italic"
                  >
                    {item}
                  </span>
                ))}
